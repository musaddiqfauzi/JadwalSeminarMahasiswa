            ...
            <div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-md-8">
								<!-- <h5>Form Seminar Hasil <label class="badge badge-light-danger">Diajukan</label></h5> -->
								<h5>Form Seminar Hasil <label class="badge badge-light-info">Diproses</label></h5>
								<hr>
								<form>
									<div class="row mb-3">
							...
							<div class="col-md-4">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-8">
										<button class="btn btn-shadow btn-success" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Download">Bor-TA2_1504105010087.pdf</button>
									</div>
								</div>
								<div class="row mb-3">
									<label for="colFormLabelSm"
									...
									<div class="col-sm-8">
										<button class="btn btn-shadow btn-success" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Download">Semhas_1504105010087.pdf</button>
									</div>
								</div>
								<div class="row mb-3">
									<label for="colFormLabelSm"
