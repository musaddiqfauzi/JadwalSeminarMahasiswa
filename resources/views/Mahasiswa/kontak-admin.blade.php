...
<head>
    <title>Jadwal Seminar | Kontak Admin</title>
					...
					<div class="row align-items-center">
						<div class="col-md-12">
							<div class="page-header-title">
								<h5 class="m-b-10">Kontak Admin</h5>
							</div>
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="/beranda"><i class="feather icon-home"></i></a></li>
								<li class="breadcrumb-item"><a href="#!">Kontak Admin</a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="user-about-block m-0">
									<div class="row">
												...
												<div class="dropdown w-auto d-inline-block">
													<div class="profile-dp">
														<div class="position-relative d-inline-block">
															<img class="img-radius img-fluid wid-100" src="assets/images/user/avatar-2.jpg" alt="User image">
														</div>
													</div>
												</div>
											</div>
											<h5 class="mb-1">Mukhsalmina</h5>
											<p class="mb-2 text-muted">Admin Jurusan Elektro</p>
										</div>
										...
										<div class="col-md-8 mt-md-4">
											<div class="row">
												<div class="col-md-6">
													<a href="#!" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-globe me-2 f-18"></i>www.elektro.unsyiah.ac.id</a>
													<div class="clearfix"></div>
													<a href="mailto:demo@domain.com" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-mail me-2 f-18"></i>adm.elektro@unsyiah.ac.id</a>
													<div class="clearfix"></div>
													<a href="#!" class="mb-1 text-muted d-flex align-items-end text-h-primary"><i class="feather icon-phone me-2 f-18"></i>+62 821-6105-9168,</a>
												</div>
												<div class="col-md-6">
													<div class="media">
														<i class="feather icon-map-pin me-2 mt-1 f-18"></i>
														<div class="flex-grow-1">
															<p class="mb-0 text-muted">Jln. Tgk. Syech Abdurrauf No. 7 Kopelma Darussalam</p>
															<p class="mb-0 text-muted">Kecamatan Syiah Kuala, Kota Banda Aceh, Provinsi Aceh</p>
															<p class="mb-0 text-muted">Indonesia (23111)</p>
														</div>
													</div>
												</div>
											</div>
