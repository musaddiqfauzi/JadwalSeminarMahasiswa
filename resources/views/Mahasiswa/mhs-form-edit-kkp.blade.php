            ...
            <div class="col-sm-12">
				<div class="card">
					<div class="card-body">
						<div class="row">
							<div class="col-md-8">
								<h5>Form Seminar KP <label class="badge badge-light-success">Selesai Dijadwalkan</label></h5>
								<hr>
								<form>
									<div class="row mb-3">
							...
							<div class="col-md-4">
								...
								<div class="row mb-3">
									...
									<div class="col-sm-8">
										<button class="btn btn-shadow btn-success" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Download">Bor-KP_1504105010087.pdf</button>
									</div>
								</div>
								<div class="row mb-3">
									<label for="colFormLabelSm"
									...
									<div class="col-sm-8">
										<button class="btn btn-shadow btn-success" type="button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Download">KP_1504105010087.pdf</button>
									</div>
								</div>
								<div class="row mb-3">
									<label for="colFormLabelSm"
